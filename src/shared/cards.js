export const CARDS = [
    {
        ...
        enables you not just to manage the content with ease, but also to make it available for
        intranet applications selectively.
        Is a feature you want not available yet? Then we will tailor-make it for you.`,
        buttonContent: "Challenges we solve"
    },
    {
        id: 1,
        name: "Consultancy",
